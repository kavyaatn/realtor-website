...
export default function EditListing() {
  ...
  async function onSubmit(e){
    ...
    if (data.length !== 0) {
      ...
      toast.error("Address invalid, enter the valid address");
      setCounter(1);
      setLoading(false);
      return;
  } 
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className='flex space-x-6 mb-6'>
            <div>
              ...
              <input type="number" id="bedrooms" value={bedrooms} onChange={onChange} min="1" max="50" required className=' w-full px-4 py-2 text-xl text-gray-300 bg-white border border-gray-700 rounded transition ease-in-out duration-150 focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
            </div>
            <div>
              <p className='text-lg font-semibold'>Baths</p>
              <input type="number" id="bathrooms" value={bathrooms} onChange={onChange} min="1" max="50" required className='w-full px-4 py-2 text-xl text-gray-300 bg-white border border-gray-700 rounded transition ease-in-out duration-150 focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
            </div>
          </div>
          ...
          <div className='flex items-center mb-6'>
            <div className=''>
              ...
              <div className='flex w-full justify-cente items-center space-x-6'>
                <input type='number' id='regularPrice' value={regularPrice} onChange={onChange} min="50" max="400000000" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out duration-150 focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
                { type === "rent" &&(
                <div className=''>
